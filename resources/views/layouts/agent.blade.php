...
<head>
    ...
    <title>@yield('title', 'Agent Dashboard') | Form Submission</title>
...
<div id="main-wrapper">
    <div class="nav-header">
        <a href="{{ route('agent.dashboard') }}" class="brand-logo d-flex align-items-center gap-2">
            <span class="brand-logo-text">Agent Panel</span>
        </a>
        ...
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                <li class="{{ request()->routeIs('agent.dashboard') ? 'mm-active' : '' }}">
                    <a href="{{ route('agent.dashboard') }}" class="ai-icon" aria-label="Dashboard">
                        <i class="flaticon-381-networking"></i><span class="nav-text">Dashboard</span>
                    </a>
                </li>
                <li class="{{ request()->routeIs('agent.report') ? 'mm-active' : '' }}">
                    <a href="{{ route('agent.report') }}" class="ai-icon" aria-label="My Report">
                        <i class="flaticon-381-list"></i><span class="nav-text">My Report</span>
                    </a>
                </li>
                <li class="{{ request()->routeIs('agent.facebook-users.*') ? 'mm-active' : '' }}">
                    <a href="{{ route('agent.facebook-users.index') }}" class="ai-icon" aria-label="Facebook Users">
