                        ...
                        <tr>
                            ...
                            <td>
                                @if($submission->submittedBy)
                                    {{ $submission->submittedBy->name }} ({{ ucfirst($submission->submittedBy->role) }})
                                @else
                                    Public
                                @endif
                            </td>
                            ...
                            <td>
                                <a href="{{ route('submissions.show', $submission) }}" class="btn btn-sm btn-outline-primary" title="View Details">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </td>
                        </tr>
